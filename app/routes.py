...
def liturgia():
    armtext = []
    a_path = os.path.normpath(os.getcwd() + r'/app/patarag-text/a')
    ...
    trltext = []
    t_path = os.path.normpath(os.getcwd() + r'/app/patarag-text/t')
    ...
    rustext = []
    r_path = os.path.normpath(os.getcwd() + r'/app/patarag-text/r')
